...
export function generateProductSchema(
  ...
  return {
    ...
    image: images || [
      `${config.siteUrl}/products/${productName.toLowerCase().replace(/\s+/g, "-")}.jpg`,
    ],
    brand: {
      "@type": "Brand",
      name: config.company.name,
    ...
    generateFAQSchema([
      {
        ...
        answer:
          "La resina epóxica es un polímero termoestable que se forma a partir de la reacción entre una resina y un endurecedor. Es conocida por su alta resistencia, durabilidad y acabado brillante.",
      },
      {
        question: "¿Cuánto tiempo dura un piso epóxico?",
        answer:
          "Un piso epóxico bien instalado puede durar entre 15 a 20 años con el mantenimiento adecuado, siendo ideal para áreas de alto tráfico industrial.",
      },
      {
        question: "¿Ofrecen garantía en sus trabajos?",
        answer:
          "Sí, ofrecemos garantía de 2 años en todos nuestros trabajos de pisos epóxicos y 1 año en muebles con resina epóxica.",
      },
    ]),
};
