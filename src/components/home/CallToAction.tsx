  ...
  return (
    <section className="bg-teal-700 py-16">
      <div className="container mx-auto px-4">
        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 md:p-12 shadow-xl relative overflow-hidden">
          {/* Decorative patterns */}
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Únete a nuestro movimiento de cambio social</h2>
        ...
        <div className="mt-16 max-w-2xl mx-auto text-center">
          <h3 className="text-2xl font-semibold text-white mb-3">Mantente informado</h3>
