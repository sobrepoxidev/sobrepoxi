       ...
       transition-[background-size,background-position] duration-300">
        ...
        <Carousel>
          ...
          <BannerTemplate linkHref="/industrial-epoxy-flooring">
            <div className="relative grid grid-cols-1 md:grid-cols-2 items-center justify-center gap-4 md:gap-6 px-2 md:px-30 py-0.5 sm:py-6 h-[100%]">
              {/* Columna 1 — texto */}
              <div className="max-w-[100%] text-center md:text-left">
                ...
                <p className="mt-1 sm:mt-2 text-start text-xs sm:text-base text-white indent-2">
                  {locale === 'es'
                ...
                <p className="mt-0 sm:mt-1 text-start text-xs sm:text-sm text-gray-300 indent-2">
                  {locale === 'es'
                ...
                <Link
                  ...
                  target="_blank"
                  className="mt-1 sm:mt-3 inline-flex items-center gap-1.5 rounded-full bg-emerald-600 hover:bg-emerald-700 text-white font-semibold px-3 sm:px-4 py-1 sm:py-1.5 shadow-sm sm:shadow-lg transition-all max-sm:text-xs"
                >
          ...
          <BannerTemplate linkHref="/luxury-design-flooring">
            <div className="relative flex flex-col items-center justify-center text-center px-3 sm:px-6 py-0 sm:py-6 h-[100%]">
              ...
              <Link href="/luxury-design-flooring" className="mt-2 sm:mt-3 bg-white/90 hover:bg-white text-black text-[0.6rem] sm:text-sm font-semibold px-2 sm:px-4 py-0.5 sm:py-1.5 rounded-full transition-all">
          ...
          <BannerTemplate linkHref="/luxury-furniture">
            <div className="relative flex flex-col items-center justify-center text-center px-3 sm:px-6 py-0 sm:py-6">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold tracking-wide gold-gradient-bright drop-shadow-[0_1px_1px_rgba(0,0,0,0.4)]">
              ...
              <Link href="/luxury-furniture" className="mt-0.5 sm:mt-3 bg-white/90 hover:bg-white text-black text-sm font-semibold px-2 sm:px-4 py-0.5 sm:py-1.5 rounded-full transition-all max-sm:text-xs">
