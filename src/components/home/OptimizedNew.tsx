       ...
       transition-[background-size,background-position] duration-300">
        ...
        <Carousel>
          ...
          >
            <div
              className="
               relative flex flex-col items-center justify-center text-center px-3 sm:px-6 py-0 sm:py-6"
            >
              {/* Columna 1 — texto */}
          ...
          <BannerTemplate linkHref="/contact">
            <div className="relative flex flex-col items-center justify-center text-center px-3 sm:px-6 py-0 sm:py-6">
              ...
              <h2 className="text-xl sm:text-3xl font-extrabold tracking-wide gold-gradient-bright drop-shadow-[0_1px_1px_rgba(0,0,0,0.4)]">
