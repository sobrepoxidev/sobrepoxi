            ...
            <div className="relative grid grid-cols-1 md:grid-cols-2 sm:items-center sm:justify-between py-0.5  md:px-30 sm:py-6  h-full ">
              ...
              <div className="max-w-[100%] sm:text-start text-center justify-start md:text-left  px-2">
                ...
                <Link
                  ...
                  target="_blank"
                  className="relative z-40 mt-0.5 sm:mt-3 inline-flex items-center gap-1 rounded-full bg-emerald-600 hover:bg-emerald-700 text-white font-semibold px-1.5 sm:px-4 py-1 sm:py-1.5 shadow-sm sm:shadow-lg transition-all max-sm:text-xs"
                >
