    ...
    "
            >
              ...
              <div className="max-w-[100%] text-center md:text-left">
                ...
                <p className="mt-0 sm:mt-1 text-sm sm:text-base text-gray-900 ">
                  {locale === 'es'
        ...
        "
          ...
          <BannerTemplate linkHref="/epoxy-floors">
            <div className="relative  flex flex-col items-center justify-center text-center px-6 py-0 sm:py-6 max-sm:mt-0.5">
              ...
              <p className="mt-1 text-sm sm:text-base text-gray-900 max-w-lg">
                {locale === 'es'
                  ? 'Efecto espejo, vetas marmoleadas y diseños únicos in-situ'
                  : 'Mirror finish, marble veins & site-specific designs'}
              </p>

              <Link href="/contact" className="mt-0.5 sm:mt-3 bg-stone-900/90 hover:bg-stone-900 text-white text-sm font-semibold px-2 sm:px-4 py-0.5 sm:py-1.5 rounded-full transition-all max-sm:text-xs">
          ...
          <BannerTemplate linkHref="/gallery">
            <div className="relative h-full flex flex-col items-center justify-center text-center px-3 sm:px-6 py-0 sm:py-6">
              <h2 className="text-md sm:text-xl font-light text-gray-900">
              ...
              <Link href="/gallery" className="mt-0.5 sm:mt-3 bg-stone-900/90 hover:bg-stone-900 text-white text-sm font-semibold px-2 sm:px-4 py-0.5 sm:py-1.5 rounded-full transition-all max-sm:text-xs">
