...
function SkeletonCard() {
    return (
      ...
      >
        ...
        <div 
          className="relative w-full bg-gray-400 h-0 rounded-t-lg overflow-hidden" 
        ...
        <div className="p-4 flex flex-col flex-grow animate-pulse">
          ...
          <div className="h-3 bg-gray-400 rounded mb-2 w-5/6"></div>
          <div className="h-3 bg-gray-400  rounded mb-2 w-2/3"></div>
  
          {/* Botón simulado */}
          <div className="mt-auto h-10 bg-teal-600/50 rounded w-full"></div>
        </div>
      </div>
    );
  }
