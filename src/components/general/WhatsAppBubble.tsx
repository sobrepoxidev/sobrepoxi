...
// Movement threshold (px) before a touch/pointer interaction is considered a drag.
// Below this, micro-movements typical of finger taps on mobile are ignored
// so the click handler can run normally.
...
export default function WhatsAppBubble() {
  ...
  return (
    ...
    >
      <span className="pointer-events-none absolute inset-0 rounded-full bg-emerald-500/30 animate-ping" style={{ animationDuration: '2.5s' }} />

      <span
        className={`pointer-events-none relative flex items-center justify-center w-full h-full rounded-full bg-emerald-500 shadow-lg shadow-emerald-500/30 transition-transform ${
