    ...
    return (
      <div className="container mx-auto px-4 py-8 text-center bg-[#121212]">
        <div className="bg-[#303030] border border-[#b68b44] rounded-lg p-6 inline-block">
          ...
          <Link 
            href="/products" 
            className="inline-flex items-center justify-center px-4 py-2 bg-gold-gradient text-black font-semibold rounded-md hover:bg-gold-gradient-bright transition"
          >
